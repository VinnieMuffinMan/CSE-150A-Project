...
Our agent's functionality is found in data_bot.py. The game is set up according to the network below: 
...
3. The remaining cards in the deck tells the player what possible cards the dealer or player can draw, indicating what either hand could possibly be.
